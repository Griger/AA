...
cat("El MSE con rf es: ", mean((pred - Boston[test,]$medv)^2), "\n")
```
...
```{r}
set.seed(41192)
BOSton = gbm(medv ~ ., data = Boston[train,], distribution = "gaussian")
pred = predict(BOSton, newdata = Boston[test,], n.trees = 100)

...
data.train = data.frame(Boston[train,var_seleccionadas], crim1 = crim1.train)
data.test = data.frame(Boston[test, var_seleccionadas], crim1 = crim1.test)

svmfit = svm(crim1~., data=data.train, kernel = "linear")
plot(svmfi)
```

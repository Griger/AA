...
```{r}
R = glm(mpg01 ~ poly(displacement,2)+poly(horsepower,2)+poly(weight,2)+displacement+horsepower+weight, data = trainRL, family = binomial)
...
```
El tamaño del árbol óptimo como ya hemos dicho antes es 4.

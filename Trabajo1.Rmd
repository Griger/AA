...
Cuando transformamos los datos de modo que pasemos a datos linealmente separables como podemos ver el error se reduce a (121) que sigue siendo un error grande pero es menor que antes. Si nos fijamos en lo que obtenemos es una elipse, la función objetivo es una circuferencia pero dado que estamos introduciendo error a las etiquetas es normal que obtengamos algo así.

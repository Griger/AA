...
A continuación vamos a explicar cómo funciona la regresion logística multinomial que nosotros hemos realizado.
...
Como teníamos clasificación multiclase, hemos hecho nostros una función, que ponemos a continuación, para obtener la matriz de confusión.
...
las métricas que se emplean en estas tables son:
...
\item \href{http://stats.stackexchange.com/questions/91484/do-discriminative-models-overfit-more-than-generative-models}{http://stats.stackexchange.com/...}
\end{enumerate}